...
## Manages Stardust Generator and related signals
...
## Triggered when timer completes a loop
...
## Wait for CCU01 to be purchased 
...
## Calculate amount of stardust which should be created every second
